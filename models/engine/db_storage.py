...
add <models>
'''
from models import base_model, user, app_server, firewall, server, ssh, ssl
    ...
    def __init__(self):
        ...
        self.__engine = create_engine(
            'mysql+mysqldb://{}:{}@{}/{}'.format(
                os.environ.get('STACK_MYSQL_USER'),
                os.environ.get('STACK_MYSQL_PWD'),
                os.environ.get('STACK_MYSQL_HOST'),
                os.environ.get('STACK_MYSQL_DB')))
        if os.environ.get("STACK_ENV") == 'test':
